...
(function (global) {
  ...
  function renderContent(content, doc) {
    ...
    heroSlot.innerHTML = content.hero.image
      ? `<img src="${content.hero.image}" alt="Project dashboard preview" style="width:100%;height:auto;border-radius:12px;display:block;">`
